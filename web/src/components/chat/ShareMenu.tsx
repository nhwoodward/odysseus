  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button title="Share a read-only link" aria-label="Share a read-only link"
      ...
      <PopoverContent side={placement === "up" ? "top" : "bottom"} align="end" sideOffset={4} className="w-[min(92vw,20rem)] rounded-xl p-3">
