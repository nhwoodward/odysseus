...
CONNECTOR_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "linear": {
        "name": "Linear", "category": "Developer", "icon": "ListChecks",
    ...
    "sentry": {
        "name": "Sentry", "category": "Monitoring", "icon": "Bug",
    ...
    "hubspot": {
        "name": "HubSpot", "category": "CRM & Sales", "icon": "Users",
    ...
    "box": {
        "name": "Box", "category": "Files", "icon": "Box",
    ...
    "postgres": {
        "name": "Postgres", "category": "Data", "icon": "Database",
    ...
    "brave": {
        "name": "Brave Search", "category": "Search", "icon": "Search",
    ...
    "todoist": {
        "name": "Todoist", "category": "Productivity", "icon": "ListChecks",
